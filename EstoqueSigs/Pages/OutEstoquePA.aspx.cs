...
{
    public partial class OutEstoquePA : System.Web.UI.Page
    {
        ...
        public void PreencherGrid()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Pedido ped = pedD.PesquisarPedidoPA();
                        ...
                        if (chkRow.Checked)
                        {
                            ...
                            if ((qtdR > 0) && (qtd > 0) && (qtdR <= qtd))
                            {
                                try
                                {
                                    ...
                                    var dr = enD.SelecionaQTDSPA(identrada);
                                    ...
                                    else
                                    {
                                        ...
                                        enD.AtualizarQTDSPA(en);
                                    }

                                    PedidoDAL pedD = new PedidoDAL();
                                    Pedido ped = pedD.PesquisarPedidoPA();
                                    int pedido = ped.NumPedido += 1;
                                    pedD.AtualizarPedidoPA(pedido);
                                    ...
                                    Response.AddHeader("REFRESH", "3;URL=../Pages/reportOut.aspx?send=" + txtProtocolo.Text + "&id=" + txtID.Text + "&uf=PA" + "&rec=" + ddlRecebedor.SelectedItem.ToString() + "&apr=" + ddlAprovador.SelectedItem.ToString());
                                }
                                catch (Exception ex)
                                {
                                    lblMsgW.Visible = true;
