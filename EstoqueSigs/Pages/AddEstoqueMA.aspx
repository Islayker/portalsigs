<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="AddEstoqueMA.aspx.cs" Inherits="EstoqueSigs.Pages.AddEstoqueMA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="Form" class="form-horizontal" data-toggle="validator" role="form" runat="server">
        ...
        <h3 class="text-center">ENTRADA DE MATERIAIS - ESTOQUE MA</h3>
        <br />
        <br />
        <fieldset>
