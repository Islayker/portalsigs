...
{
    public partial class OutEstoqueMG : System.Web.UI.Page
    {
        ...
        protected void ddlID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //    txtOS.Text = dt.Rows[1]["Num_OS"].ToString();
            //    txtSite.Text = dt.Rows[2]["UF"].ToString() + " - " + dt.Rows[3]["Site"].ToString();
            //    txtLocalidade.Text = dt.Rows[4]["Localidade"].ToString();
            //}
        }
        ...
        public void PreencherGrid()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Pedido ped = pedD.PesquisarPedidoMG();
                        ...
                        if (chkRow.Checked)
                        {
                            ...
                            if ((qtdR > 0) && (qtd > 0) && (qtdR <= qtd))
                            {
                                try
                                {
                                    ...
                                    var dr = enD.SelecionaQTDS(identrada);
                                    ...
                                    else
                                    {
                                        ...
                                        enD.AtualizarQTDS(en);
                                    }

                                    PedidoDAL pedD = new PedidoDAL();
                                    Pedido ped = pedD.PesquisarPedidoMG();
                                    int pedido = ped.NumPedido += 1;
                                    pedD.AtualizarPedidoMG(pedido);
                                    ...
                                    Response.AddHeader("REFRESH", "3;URL=../Pages/reportOut.aspx?send=" + txtProtocolo.Text + "&id=" + txtID.Text + "&uf=MG" + "&rec=" + ddlRecebedor.SelectedItem.ToString() + "&apr=" + ddlAprovador.SelectedItem.ToString());
                                }
                                catch (Exception ex)
                                {
                                    lblMsgW.Visible = true;
