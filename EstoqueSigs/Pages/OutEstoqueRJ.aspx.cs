...
{
    public partial class OutEstoqueRJ : System.Web.UI.Page
    {
        ...
        public void PreencherGrid()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Pedido ped = pedD.PesquisarPedidoRJ();
                        ...
                        if (chkRow.Checked)
                        {
                            ...
                            if ((qtdR > 0) && (qtd > 0) && (qtdR <= qtd))
                            {
                                try
                                {
                                    ...
                                    var dr = enD.SelecionaQTDSRJ(identrada);
                                    ...
                                    else
                                    {
                                        ...
                                        enD.AtualizarQTDSRJ(en);
                                    }

                                    PedidoDAL pedD = new PedidoDAL();
                                    Pedido ped = pedD.PesquisarPedidoRJ();
                                    int pedido = ped.NumPedido += 1;
                                    pedD.AtualizarPedidoRJ(pedido);
                                    ...
                                    Response.AddHeader("REFRESH", "3;URL=../Pages/reportOut.aspx?send=" + txtProtocolo.Text + "&id=" + txtID.Text + "&uf=RJ" + "&rec=" + ddlRecebedor.SelectedItem.ToString() + "&apr=" + ddlAprovador.SelectedItem.ToString());
                                }
                                catch (Exception ex)
                                {
                                    lblMsgW.Visible = true;
