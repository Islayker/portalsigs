<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="EstoqueGeral.aspx.cs" Inherits="EstoqueSigs.Pages.EstoqueGeral" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="Form" class="form-horizontal" data-toggle="validator" role="form" runat="server">
        ...
        <h3 class="text-center">ENTRADA DE MATERIAIS - ESTOQUE GERAL</h3>
        <br />
        <br />
        <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
        ...
        <div class="col-md-2">
          <asp:LinkButton ID="btnFiltrar" CssClass="btn btn-sm btn-success" runat="server" TabIndex="6" OnClick="btnFiltrar_Click"><span class="glyphicon glyphicon-filter">&emsp;Filtrar</span></asp:LinkButton>
      </div>
        </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
          <asp:DropDownList ID="ddlOrigem" runat="server" CssClass="form-control" Width="300px">
              ...
              <asp:ListItem>SOBRA DE PROJETO</asp:ListItem>
          </asp:DropDownList>
      </div>
        </div>
    <div class="form-group">
      ...
      <div class="col-md-10">
          <asp:DropDownList ID="ddlDestino" runat="server" CssClass="form-control" Width="300px">
              <asp:ListItem Selected="True">Selecione o Destino do Equipamento</asp:ListItem>
              <asp:ListItem>ESTOQUE ES</asp:ListItem>
              <asp:ListItem>ESTOQUE MA</asp:ListItem>
              <asp:ListItem>ESTOQUE MG</asp:ListItem>
              <asp:ListItem>ESTOQUE PA</asp:ListItem>
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
          <asp:TextBox ID="txtData" runat="server" CssClass="form-control" Width="150px" MaxLength="10" placeholder="MM/AA/AAAA" onkeyup="formataData(this,event)" data-error="Informe a Data." required TextMode="Date"></asp:TextBox>
          <div class="help-block with-errors"></div>
      </div>
        </div>
                    <div class="form-group">
      ...
      <div class="col-md-10">
          <asp:TextBox ID="txtObs" runat="server" CssClass="form-control" Width="400px" placeholder="Informações relevantes. Ex: OS, Localidade e etc." data-error="Informe a Observação." required Rows="2" TextMode="MultiLine"></asp:TextBox>
          <div class="help-block with-errors"></div>
      </div>
        </div>
                <br />
