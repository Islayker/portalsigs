<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="TransferID.aspx.cs" Inherits="EstoqueSigs.Pages.TransferID" %>
...
<asp:GridView ID="grdEstoque" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="table table-striped table-bordered table-hover" DataKeyNames="PK_GERAL,Codigo" EditRowStyle-HorizontalAlign="Center" EditRowStyle-VerticalAlign="Middle" ForeColor="#333333" GridLines="None" RowStyle-HorizontalAlign="Center" RowStyle-VerticalAlign="Middle">
                    ...
                    <legend class="text-center">Informações do Destino</legend>
    <div class="form-group">
      <div class="col-md-8 col-md-offset-3">
          <asp:DropDownList ID="ddlID" runat="server" CssClass="form-control" Width="500px" OnSelectedIndexChanged="ddlID_SelectedIndexChanged" AutoPostBack="True">
          </asp:DropDownList>
      </div>
        </div>
                <br />
