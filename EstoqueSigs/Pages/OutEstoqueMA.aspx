<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="OutEstoqueMA.aspx.cs" Inherits="EstoqueSigs.Pages.OutEstoqueMA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="Form" class="form-horizontal" data-toggle="validator" role="form" runat="server">
        ...
        <h3 class="text-center">SÁIDA DE MATERIAIS - ESTOQUE MA</h3>
        <br />
        <br />
        <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
          <asp:DropDownList ID="ddlRecebedor" runat="server" CssClass="form-control" Width="300px" DataSourceID="sqlDSMA" DataTextField="RECEBEDOR" DataValueField="PK_RECEBEDOR">
          </asp:DropDownList>
<%--          <asp:SqlDataSource ID="sqlAzureRecebedorMA" runat="server" ConnectionString="<%$ ConnectionStrings:portalsigsdbAzure %>" SelectCommand="SELECT [PK_RECEBEDOR], [RECEBEDOR] FROM [TB_RECEBEDOR] WHERE ([ESTADO] = @ESTADO) ORDER BY [RECEBEDOR]">
              <SelectParameters>
                  <asp:Parameter DefaultValue="MA" Name="ESTADO" Type="String" />
              </SelectParameters>
          </asp:SqlDataSource>--%>
          <asp:SqlDataSource ID="sqlDSMA" runat="server" ConnectionString="Data Source=(local)\SQLEXPRESS;Initial Catalog=portalsigsdb;Persist Security Info=True;User ID=sa;Password=Portal@2022" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [PK_RECEBEDOR], [RECEBEDOR] FROM [TB_RECEBEDOR] WHERE ([ESTADO] = @ESTADO)">
              <SelectParameters>
                  <asp:Parameter DefaultValue="MA" Name="ESTADO" Type="String" />
              </SelectParameters>
          </asp:SqlDataSource>
